...
<body>
    ...
    <div style="position: relative;">
        ...
        <div class="menu" id="menu">
            ...
            <a href="#" onclick="showContent('voluntaarios')">Voluntarios</a>
        ...
        <div id="voluntarios" class="desc2">
            ...
            <form action="../php/perfil_organizacion.php" method="post">
                <div class="form-control">
                    ...
                    <input type="text" id="descripcion" name="descripcion" value="<?php echo $_SESSION['descripcion'] ?>" readonly></input>
                    <br>
